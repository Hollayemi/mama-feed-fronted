  ...
  return (
    <HomeWrapper>
      <Box className="w-full relative bg-pink-50 flex flex-col items-center !-mt-24 !pt-32">
        ...
        <Box className="!absolute top-60 left-60 !w-5 !h-5 !rounded-full bg-green-200"></Box>
        <Box className="!absolute bottom-20 left-10 !w-40 !h-40 !rounded-full bg-blue-100"></Box>
        <Box className="!absolute top-40 right-96 !w-16 !h-16 !rounded-full bg-gray-200"></Box>
        <Box className="!absolute bottom-10 right-14 !w-32 !h-32 !rounded-full bg-pink-100"></Box>
        <Box className="!absolute top-40 left-10 !w-10 !h-10 !rounded-full bg-slate-300"></Box>
      </Box>
        ...
        <Box className="!mt-24 px-3 md:px-16">
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="h5" className="!text-[13px] mt-2 !ml-9 !leading-6">
              ...
              <Typography variant="h5" className="!text-[13px] mt-2 !ml-9 !leading-6">
              Every stitch, seam, and button is a testament to our dedication to quality. We work closely with brands that share our passion for craftsmanship, resulting in clothing that is not only beautiful but also well-made.
              </Typography>
