...
import { adminLogin } from "@/app/redux/state/slices/auth/Login";
...
const LoginV1 = () => {
  ...
  return (
    <Box className="flex justify-center items-center h-screen">
      <Box className="flex flex-col justify-evenly w-[390px] bg-white !rounded-xl border h-4/6 px-4 md:px-6">
        <Box className="!flex !flex-col !items-center">
          <Box className="font-bold !flex !items-center !text-[20px] sm:!text-[22px] text-center">
          ...
          <Typography className="!text-[12px] sm:!text-[15px] text-center">
            Log in to Your MamaFeeds Admin Account
          </Typography>
        </Box>
        ...
        <Box>
          <Button
            ...
            onClick={() => adminLogin(payload, router, dispatch)}
          >
            Login
          </Button>
        </Box>
