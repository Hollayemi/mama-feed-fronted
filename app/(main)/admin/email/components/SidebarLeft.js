...
import CustomBadge from '@/app/components/badge'
      ...
      <ScrollWrapper>
        <Box sx={{ pt: 0, overflowY: 'hidden' }}>
          ...
          <List component='div'>
            <ListItemStyled
              component={Link}
              href='/admin/email/label/personal'
              onClick={handleListItemClick}
              sx={{
            ...
            <ListItemStyled
              component={Link}
              href='/admin/email/label/company'
              onClick={handleListItemClick}
              sx={{
            ...
            <ListItemStyled
              component={Link}
              href='/admin/email/label/important'
              onClick={handleListItemClick}
              sx={{
            ...
            <ListItemStyled
              component={Link}
              href='/admin/email/label/private'
              onClick={handleListItemClick}
              sx={{
